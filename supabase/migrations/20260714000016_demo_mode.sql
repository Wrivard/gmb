-- Mode démo / mode réel : les clients seed (fictifs) portent is_demo et
-- les surfaces de liste filtrent selon le mode choisi (cookie, toggle
-- dans Réglages). Les vrais clients restent is_demo = false.

alter table public.clients
  add column is_demo boolean not null default false;

-- Les 8 clients du seed initial (ids c0000000-…).
update public.clients set is_demo = true where id::text like 'c0000000-%';
